...
* **Beispiel:** https://www.w3.org/TR/json-ld11/ hält ein [EXAMPLE4](https://www.w3.org/TR/json-ld11/#example-4-context-for-the-sample-document-in-the-previous-section) mit *"@context: { ... }"* bereit.
