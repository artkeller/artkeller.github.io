...
* **Hinweis**: Der schema.org Parser unterstützt keine **"unbekannten" URLs** für @context und meldet: *"Dieser @context-String ist dem Parser unbekannt und das Abrufen des Remote-JSON-LD-Kontexts wird von uns nicht unterstützt. Verwenden Sie einen bekannten @context-Wert (z. B. „https://schema.org/“) oder definieren Sie einen lokalen Kontext."*
...
* **W3C @context-files:** siehe weitere durch W3C definierte [@context-files](https://www.w3.org/2025/credentials/vcdi/vocab/v2/vocabulary.html#context-files). Für uns interessant ist z. B. [security/data-integrity/v2](https://www.w3.org/2025/credentials/vcdi/context/v2.jsonld)
